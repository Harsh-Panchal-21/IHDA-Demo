...
const translations: Record<LanguageCode, Record<string, string>> = {
  en: {
    ...
    tollFree: "Toll-Free",
    supportHours: "9 AM - 5 PM CST, 7 Days",
    languagesAvailable: "English, Spanish, Polish",
    getHelp: "Get Help",
    howCanWeHelp: "How Can We Help You?",
    supportPageDesc: "Our support team is available 7 days a week to assist you with housing search, applications, and any issues you may encounter.",
    availableHours: "Available 9 AM - 5 PM CST",
    multilingualSupport: "English, Spanish & Polish Support",
    excludingHolidays: "Excluding federally recognized holidays",
    chooseContactMethod: "Choose the contact method that works best for you.",
    phoneSupport: "Phone Support",
    phoneSupportDesc: "Speak directly with a housing specialist",
    tollFree7Days: "Toll-free, 7 days a week",
    emailSupport: "Email Support",
    emailSupportDesc: "Get detailed assistance via email",
    emailResponseTime: "Response within 24-48 hours",
    liveChat: "Live Chat",
    liveChatDesc: "Chat with us in real-time",
    liveChatHours: "Mon-Fri 9AM-5PM CST",
    startChat: "Start Chat",
    sendEmail: "Send Email",
    whatWeCanHelpWith: "What We Can Help With",
    supportAreasDesc: "Our support team can assist with both searching for housing and managing property listings.",
    housingSearchHelp: "Housing Search Help",
    housingSearchHelpDesc: "Assistance with searching for properties, using filters, understanding listings, and navigating the website.",
    landlordSupport: "Landlord & Property Manager Support",
    landlordSupportDesc: "Help with listing creation, property updates, account management, and tenant applications.",
    applicationAssistance: "Application Assistance",
    applicationAssistanceDesc: "Support with applying to properties, checking eligibility, and understanding program requirements.",
    reportIssues: "Report Issues",
    reportIssuesDesc: "Report housing discrimination, misleading listings, poor housing conditions, or website errors.",
    multilingualSupportTitle: "Multilingual Support",
    multilingualSupportDesc: "We provide customer support in multiple languages to better serve all Illinois residents.",
    supportHoursTitle: "Support Hours",
    everyDay: "Every Day",
    holidays: "Federal Holidays",
    note: "Note",
    holidayNote: "We are closed on all federally recognized holidays including New Year's Day, MLK Day, Presidents Day, Memorial Day, Independence Day, Labor Day, Columbus Day, Veterans Day, Thanksgiving, and Christmas.",
    needEscalation: "Need to Escalate an Issue?",
    escalationDesc: "If your issue requires administrator attention or you need to file a formal complaint, contact our specialized teams.",
    websiteAdministrator: "Website Administrator",
    technicalIssues: "For technical issues and website errors",
    complianceOffice: "Compliance Office",
    discriminationComplaints: "For discrimination and compliance complaints",

    // Report Form
    fileReport: "File a Report",
    reportIssueTitle: "Report an Issue",
    reportIssueDesc: "Use this form to report housing discrimination, misleading listings, poor housing conditions, or technical issues with the website.",
    selectReportType: "Select Report Type",
    selectReportTypeDesc: "Choose the type of issue you want to report.",
    housingDiscrimination: "Housing Discrimination",
    discriminationDesc: "Report discrimination based on race, color, religion, sex, national origin, disability, or familial status.",
    misleadingListing: "Misleading Listing",
    misleadingDesc: "Report inaccurate information, false advertising, or deceptive practices in property listings.",
    poorConditions: "Poor Housing Conditions",
    conditionsDesc: "Report unsafe living conditions, code violations, or failure to maintain habitable premises.",
    websiteIssue: "Website Issue",
    technicalDesc: "Report bugs, errors, or technical problems with the website or listing system.",
    discriminationDetails: "Discrimination Details",
    discriminationDetailsDesc: "Please provide details about the discrimination you experienced.",
    basisOfDiscrimination: "Basis of Discrimination (select all that apply)",
    importantNote: "Important",
    discriminationForwardNote: "Discrimination complaints will be forwarded to the Illinois Department of Human Rights and HUD for investigation.",
    propertyInformation: "Property Information",
    propertyInfoDesc: "Provide information about the property related to your report.",
    ...
    propertyManagerLandlord: "Property Manager / Landlord Name",
    enterName: "Enter name if known",
    describeIssue: "Describe the Issue",
    describeIssueDesc: "Provide a detailed description of the issue you are reporting.",
    dateOfIncident: "Date of Incident",
    detailedDescription: "Detailed Description",
    descriptionPlaceholder: "Please describe the issue in detail. Include specific incidents, dates, names of people involved, and any other relevant information.",
    uploadEvidence: "Upload Supporting Documents",
    acceptedFormats: "Accepted formats: Images (JPG, PNG), PDF, Word documents. Max 10MB per file.",
    yourContactInfo: "Your Contact Information",
    contactInfoDesc: "We need your contact information to follow up on your report.",
    ...
    both: "Both",
    anonymousReport: "I wish to remain anonymous (Note: This may limit our ability to investigate)",
    reportWillBeForwarded: "This report will be forwarded to",
    submitReport: "Submit Report",
    needImmediateHelp: "Need Immediate Help?",
    emergencyContact: "If you need immediate assistance, call us at",
    or: "or email",
    reportSubmitted: "Report Submitted Successfully",
    reportSubmittedDesc: "Thank you for your report. We take all complaints seriously and will investigate promptly.",
    whatHappensNext: "What Happens Next",
    nextStep1: "Your report will be reviewed within 24-48 hours",
    nextStep2: "If needed, we will contact you for additional information",
    nextStep3: "Your report will be forwarded to the appropriate agency for investigation",
  ...
  es: {
    ...
    tollFree: "Gratis",
    supportHours: "9 AM - 5 PM CST, 7 Días",
    languagesAvailable: "Inglés, Español, Polaco",
    getHelp: "Obtener Ayuda",
    howCanWeHelp: "¿Cómo Podemos Ayudarle?",
    supportPageDesc: "Nuestro equipo de soporte está disponible 7 días a la semana para ayudarle con la búsqueda de vivienda, solicitudes y cualquier problema.",
    availableHours: "Disponible 9 AM - 5 PM CST",
    multilingualSupport: "Soporte en Inglés, Español y Polaco",
    excludingHolidays: "Excepto días festivos federales",
    chooseContactMethod: "Elija el método de contacto que mejor le funcione.",
    phoneSupport: "Soporte Telefónico",
    phoneSupportDesc: "Hable directamente con un especialista en vivienda",
    tollFree7Days: "Gratis, 7 días a la semana",
    emailSupport: "Soporte por Email",
    emailSupportDesc: "Obtenga asistencia detallada por correo",
    emailResponseTime: "Respuesta en 24-48 horas",
    liveChat: "Chat en Vivo",
    liveChatDesc: "Chatee con nosotros en tiempo real",
    liveChatHours: "Lun-Vie 9AM-5PM CST",
    startChat: "Iniciar Chat",
    sendEmail: "Enviar Email",
    whatWeCanHelpWith: "En Qué Podemos Ayudarle",
    supportAreasDesc: "Nuestro equipo puede ayudarle tanto con la búsqueda de vivienda como con la gestión de listados.",
    fileReport: "Presentar Queja",
